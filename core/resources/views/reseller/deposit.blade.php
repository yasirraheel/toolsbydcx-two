...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <form class="deposit-form" action="{{ route('reseller.deposit.insert') }}" method="post">
                @csrf
                <input name="currency" type="hidden">
                <div class="gateway-card card custom--card">
                    <div class="card-header">
                        <h5 class="card-title text-white mb-0">
                            <i class="las la-wallet text--primary me-1"></i> @lang('Recharge Reseller Wallet')
                        </h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-lg-6">
                                <div class="payment-system-list p-3">
                                    <div class="deposit-info">
                                        ...
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                ...
                                                <input class="form-control form--control amount" name="amount" type="number" step="any" value="{{ old('amount') }}" placeholder="@lang('00.00')" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <p class="text has-icon">@lang('Processing Charge')
                                                <span class="proccessing-fee-info" data-bs-toggle="tooltip" title="@lang('Processing charge for payment gateways')"><i class="las la-info-circle"></i></span>
                                            </p>
                                        </div>
                                        <div class="deposit-info__input">
                                    ...
                                    <div class="info-text pt-3">
                                        <p class="text">@lang('Funds will be credited directly to your reseller wallet upon payment confirmation.')</p>
                                    </div>
                                </div>
                            </div>
                        </div>
