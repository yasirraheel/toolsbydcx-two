...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/templates/basic/css/select2.min.css') }}">
...
<body>
            ...
            <div class="col-xl-2 col-lg-3">
                <div class="card p-2 sticky-top" style="top: 80px;">
                    <nav class="nav nav-pills flex-column gap-1">
                        ...
                        <a class="nav-link text-success fw-bold" href="{{ route('user.deposit.index') }}">
    ...
    <script src="{{ asset('assets/templates/basic/js/select2.min.js') }}"></script>
