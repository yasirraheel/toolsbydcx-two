                                    ...
                                    @foreach ($content as $imgKey => $image)
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-image-uploader class="w-100" :imagePath="frontendImage($key,@$data->data_values->$imgKey,getFileSize('seo'))" name="image_input[{{ @$imgKey }}]" id="image-upload-input{{ $loop->index }}" :size="$section->element->images->$imgKey->size" :required="false" />
