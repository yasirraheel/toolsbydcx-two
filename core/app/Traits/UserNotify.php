...
trait UserNotify
{
    public static function notifyToUser(){
        return [
            ...
            'draftAccount'=>'Users Who Have Draft Listings',
            'activeAccount'=>'Users Who Have Active Listings',
            'pendingAccount'=>'Users Who Have Pending Listings',
            'rejectedAccount'=>'Users Who Have Rejected Listings',
            'inactiveAccount'=>'Users Who Have Inactive Listings',
            'soldAccount'=>'Users Who Have Sold Listings',
            'noAccount'=>'Users Who Have No Listings',
        ];
    }
    ...
    public function scopeDraftAccount($query){
        return $query->whereHas('accounts',function($q){
            $q->where('status',Status::LISTING_DRAFT);
        });
    }
    ...
    public function scopeInactiveAccount($query){
        return $query->whereHas('accounts',function($q){
            $q->where('status',Status::LISTING_INACTIVE);
        });
    }

    public function scopePendingAccount($query){
        return $query->whereHas('accounts',function($q){
            $q->where('status',Status::LISTING_PENDING);
        });
    }

    public function scopeRejectedAccount($query){
        return $query->whereHas('accounts',function($q){
            $q->where('status',Status::LISTING_REJECTED);
        });
    }

    public function scopeSoldAccount($query){
        return $query->whereHas('accounts',function($q){
            $q->where('status',Status::LISTING_SOLD);
        });
    }

    public function scopeNoAccount($query){
        return $query->whereDoesntHave('accounts');
    }
